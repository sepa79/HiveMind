...
server.registerTool(
  ...
  async ({ sessionId, config }) => updateWizardStep(sessionId, WIZARD_STEP.PROCESSOR_CONFIG, { config })
);
...
server.registerTool(
  ...
  async ({ sessionId, inputs }) => updateWizardStep(sessionId, WIZARD_STEP.GENERATOR_INPUTS, { inputs })
);
...
server.registerTool(
  ...
  async ({ sessionId, plan }) => updateWizardStep(sessionId, WIZARD_STEP.PLAN_SWARM, { plan })
);
...
server.registerTool(
  ...
  async ({ sessionId, worker }) => updateWizardStep(sessionId, WIZARD_STEP.GENERATOR_WORKER_MESSAGE, { worker })
);
...
server.registerTool(
  ...
  async ({ sessionId, requestBuilder }) =>
    updateWizardStep(sessionId, WIZARD_STEP.REQUEST_BUILDER_CONFIG, { requestBuilder })
);
...
server.registerTool(
  ...
  async ({ sessionId, template }) => updateWizardStep(sessionId, WIZARD_STEP.TEMPLATE_HTTP_PUT, { template })
);
