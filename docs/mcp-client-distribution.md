...
```bash
code --add-mcp '{"name":"hivemind","type":"stdio","command":"npx","args":["-y","/path/to/hivemind-mcp-0.1.2.tgz"],"env":{"HIVEMIND_API_BASE_URL":"https://hivemind.example.com"}}'
```
...
scripts/install-vscode-hivemind-mcp.sh https://hivemind.example.com /path/to/hivemind-mcp-0.1.2.tgz
```
